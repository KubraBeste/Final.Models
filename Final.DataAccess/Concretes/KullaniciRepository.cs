...
namespace Final.DataAccess.Concretes
{
    ...
    public class KullaniciRepository : IRepository<Kullanici>, IDisposable
    {
        ...
        public IList<Kullanici> SelectAll()
        {
            ...
            IList<Kullanici> kullanici = new List<Kullanici>();
        ...
        public Kullanici SelectedById(int id)
        {
            ...
            try
            {
                ...
                kullanici.Kiralama = new KiralamaRepository().SelectAll().Where(x => x.KiralayanKisi.Equals(kullanici.CustomerID)).ToList();
                kullanici.Teslim = new TeslimRepository().SelectAll().Where(x => x.TeslimEdenKisi.Equals(kullanici.CustomerID)).ToList();
                return kullanici;
            }
            catch (Exception ex)
            {
            ...
            try
            {
                ...
                using (var dbConnection = _dbProviderFactory.CreateConnection())
                {
                    ...
                    using (var dbCommand = _dbProviderFactory.CreateCommand())
                    {
                        ...
                        DBHelper.AddParameter(dbCommand, "@CustomerSurname", CsType.String, ParameterDirection.Input, entity.CustomerSurname);
                        DBHelper.AddParameter(dbCommand, "@CustomerPasskey", CsType.String, ParameterDirection.Input, entity.CustomerPasskey);
                        DBHelper.AddParameter(dbCommand, "@CustomerTC", CsType.Int, ParameterDirection.Input, entity.CustomerTC);
